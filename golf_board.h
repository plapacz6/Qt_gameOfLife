...
class T_GolfBoard : public QAbstractTableModel
{
    ...
    bool editable_state;
    int board_preview_width = Golf_ROWS;
    int board_preview_hight = Golf_COLS;
...
public:
    ...
    int starting_row_of_view;   //sets the board coordinates from which the board preview starts
